...
$$.RotateBullet = {"":
 ...
 update$0: function() {
  ...
  if (typeof t2 !== 'number')
    throw $.iae(t2);
  t1 *= t2;
  var t3 = this._centerPosX;
  if (typeof t3 !== 'number')
    throw $.iae(t3);
  this.set$px(t1 + t3);
  t2 = $.cos(this._theta) * t2;
  var t4 = this._centerPosY;
  if (typeof t4 !== 'number')
    throw $.iae(t4);
  this.set$py(t2 + t4);
  this._centerPosX = $.add(this._centerPosX, this.get$vx());
  this._centerPosY = $.add(this._centerPosY, this.get$vy());
},
 draw$1: function(context) {
  context.set$fillStyle(this._color);
  context.beginPath$0();
  context.arc$6(this.get$px(), this.get$py(), this._size, 0, 6.283185307179586, true);
  context.closePath$0();
  context.fill$0();
},
 RotateBullet$7: function(px, py, vx, vy, _rotateSpeed, _radius, _size) {
  ...
  this._centerPosY = py;
  var t1 = this._colors;
  var t2 = $.Random_Random(null).nextInt$1(t1.length);
  if (t2 !== (t2 | 0))
    throw $.iae(t2);
...
$$.Example01_draw_function = {"":
 ...
 "super": "Closure",
 call$1: function(bullet) {
  return bullet.draw$1(this.context_0);
}
};
