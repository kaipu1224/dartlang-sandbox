...
$$.main_anon = {"":
 ...
 call$1: function(e) {
  var s = e.get$target();
  $.selectImage($.index(s.get$nodes(), $.add(s.get$selectedIndex(), 1)).get$text());
}
};
...
$$.main_anon0 = {"":
 ...
 call$1: function(item) {
  return $.add$1(this.selectMenu_0.get$nodes(), $.OptionElement_OptionElement(item, item, false, false));
}
};
...
$.selectImage = function(imageName) {
  $.img.set$src(imageName);
  $.add$1($.img.get$on().get$load(), new $.selectImage_anon());
};
...
$.drawImage = function() {
  var t1 = $.img.get$width();
  $.canvas.set$width(t1);
  t1 = $.img.get$height();
  $.canvas.set$height(t1);
  var context = $.canvas.getContext$1('2d');
  context.set$fillStyle('black');
  context.fillRect$4(0, 0, $.canvas.get$width(), $.canvas.get$height());
  context.drawImage$5($.img, 0, 0, $.img.get$width(), $.img.get$height());
};
...
$.main = function() {
  ...
  var selectMenu = $.query('#imgSelect');
  $.add$1(selectMenu.get$on().get$change(), new $.main_anon());
  $.forEach(images, new $.main_anon0(selectMenu));
  if (0 >= images.length)
    throw $.ioore(0);
  $.selectImage(images[0]);
  $.add$1($.query('#grayBtn').get$on().get$click(), new $.main_anon1());
  $.add$1($.query('#sepiaBtn').get$on().get$click(), new $.main_anon2());
  $.add$1($.query('#negaBtn').get$on().get$click(), new $.main_anon3());
  $.add$1($.query('#mozaBtn').get$on().get$click(), new $.main_anon4());
};
...
$.mozaFilter = function() {
  var context = $.canvas.getContext$1('2d');
  context.getImageData$4(0, 0, $.img.get$width(), $.img.get$height());
  var w = $.toInt($.div($.img.get$width(), 8));
  if (typeof w !== 'number')
    return $.mozaFilter$bailout(1, w, context, 0, 0, 0, 0, 0, 0, 0);
  var h = $.toInt($.div($.img.get$height(), 8));
  if (typeof h !== 'number')
    return $.mozaFilter$bailout(2, w, context, h, 0, 0, 0, 0, 0, 0);
  for (var i = 0; i < w; ++i)
    for (var px = i * 8, j = 0; j < h; ++j) {
      var py = j * 8;
      var block = context.getImageData$4(px, py, 8, 8);
      var len = $.toInt($.div($.get$length(block.get$data()), 4));
      if (typeof len !== 'number')
        return $.mozaFilter$bailout(3, w, context, len, h, px, py, block, j, i);
      for (var gg = 0, rr = 0, bb = 0, k = 0; k < len; ++k) {
        var t1 = block.get$data();
        var t2 = k * 4;
        t1 = $.index(t1, t2);
        if (typeof t1 !== 'number')
          throw $.iae(t1);
        rr += t1;
        t1 = $.index(block.get$data(), t2 + 1);
        if (typeof t1 !== 'number')
          throw $.iae(t1);
        gg += t1;
        t1 = $.index(block.get$data(), t2 + 2);
        if (typeof t1 !== 'number')
          throw $.iae(t1);
        bb += t1;
      }
      var rr0 = $.toInt(rr / len);
      var gg0 = $.toInt(gg / len);
      var bb0 = $.toInt(bb / len);
      context.set$fillStyle('rgb(' + $.S(rr0) + ',' + $.S(gg0) + ',' + $.S(bb0) + ')');
      context.fillRect$4(px, py, 8, 8);
    }
};
...
$.grayscaleFilter = function() {
  var context = $.canvas.getContext$1('2d');
  var imgPixels = context.getImageData$4(0, 0, $.img.get$width(), $.img.get$height());
  var pixLength = $.mul($.mul($.img.get$width(), $.img.get$height()), 4);
  if (typeof pixLength !== 'number')
    return $.grayscaleFilter$bailout(1, imgPixels, pixLength, context);
  for (var green = null, blue = null, gray = null, red = null, i = 0; i < pixLength; i += 4) {
    red = $.index(imgPixels.get$data(), i);
    var t1 = imgPixels.get$data();
    var t2 = i + 1;
    green = $.index(t1, t2);
    t1 = imgPixels.get$data();
    var t3 = i + 2;
    blue = $.index(t1, t3);
    ...
    if (typeof blue !== 'number')
      throw $.iae(blue);
    gray = $.toInt(t1 + 0.114 * blue);
    $.indexSet(imgPixels.get$data(), i, gray);
    $.indexSet(imgPixels.get$data(), t2, gray);
    $.indexSet(imgPixels.get$data(), t3, gray);
  }
  context.putImageData$7(imgPixels, 0, 0, 0, 0, imgPixels.get$width(), imgPixels.get$height());
};
...
$.negaFilter = function() {
  ...
  var pixLength = $.mul($.mul($.img.get$width(), $.img.get$height()), 4);
  if (typeof pixLength !== 'number')
    return $.negaFilter$bailout(1, imgPixels, pixLength, context);
  for (var green = null, blue = null, red = null, i = 0; i < pixLength; i += 4) {
    red = $.index(imgPixels.get$data(), i);
    var t1 = imgPixels.get$data();
    var t2 = i + 1;
    green = $.index(t1, t2);
    ...
    if (typeof red !== 'number')
      throw $.iae(red);
    $.indexSet(t1, i, 255 - red);
    t1 = imgPixels.get$data();
    if (typeof green !== 'number')
      throw $.iae(green);
    $.indexSet(t1, t2, 255 - green);
    t2 = imgPixels.get$data();
    if (typeof blue !== 'number')
      throw $.iae(blue);
    $.indexSet(t2, t3, 255 - blue);
  }
  context.putImageData$7(imgPixels, 0, 0, 0, 0, imgPixels.get$width(), imgPixels.get$height());
};
...
$.sepiaFilter = function() {
  ...
  var pixLength = $.mul($.mul($.img.get$width(), $.img.get$height()), 4);
  if (typeof pixLength !== 'number')
    return $.sepiaFilter$bailout(1, imgPixels, pixLength, context);
  for (var green = null, sepia = null, blue = null, red = null, i = 0; i < pixLength; i += 4) {
    red = $.index(imgPixels.get$data(), i);
    var t1 = imgPixels.get$data();
    var t2 = i + 1;
    green = $.index(t1, t2);
    ...
    if (typeof blue !== 'number')
      throw $.iae(blue);
    sepia = $.toInt(t1 + 0.114 * blue);
    $.indexSet(imgPixels.get$data(), i, $.toInt($.mul($.div(sepia, 255), 240)));
    $.indexSet(imgPixels.get$data(), t2, $.toInt($.mul($.div(sepia, 255), 200)));
    $.indexSet(imgPixels.get$data(), t3, $.toInt($.mul($.div(sepia, 255), 145)));
  }
  context.putImageData$7(imgPixels, 0, 0, 0, 0, imgPixels.get$width(), imgPixels.get$height());
};
...
$.mozaFilter$bailout = function(state, env0, env1, env2, env3, env4, env5, env6, env7, env8) {
  switch (state) {
    case 1:
      w = env0;
      context = env1;
              ...
              L1:
                while (true)
                  switch (state) {
                    ...
                    case 3:
                      state = 0;
                      for (var gg = 0, rr = 0, bb = 0, k = 0; $.ltB(k, len); ++k) {
                        var t1 = block.get$data();
                        var t2 = k * 4;
                        t1 = $.index(t1, t2);
                        if (typeof t1 !== 'number')
...
$.sepiaFilter$bailout = function(state, imgPixels, pixLength, context) {
  for (var green = null, sepia = null, blue = null, red = null, i = 0; $.ltB(i, pixLength); i += 4) {
    red = $.index(imgPixels.get$data(), i);
    var t1 = imgPixels.get$data();
    var t2 = i + 1;
    green = $.index(t1, t2);
...
$.grayscaleFilter$bailout = function(state, imgPixels, pixLength, context) {
  for (var green = null, blue = null, gray = null, red = null, i = 0; $.ltB(i, pixLength); i += 4) {
    red = $.index(imgPixels.get$data(), i);
    var t1 = imgPixels.get$data();
    var t2 = i + 1;
    green = $.index(t1, t2);
...
$.negaFilter$bailout = function(state, imgPixels, pixLength, context) {
  for (var green = null, blue = null, red = null, i = 0; $.ltB(i, pixLength); i += 4) {
    red = $.index(imgPixels.get$data(), i);
    var t1 = imgPixels.get$data();
    var t2 = i + 1;
    green = $.index(t1, t2);
...
$.CTC23 = 'structured clone of ImageData';
...
$.$defineNativeClass('HTMLSelectElement', ["length=", "selectedIndex?"], {
});
...
//@ sourceMappingURL=example08.dart.js.map